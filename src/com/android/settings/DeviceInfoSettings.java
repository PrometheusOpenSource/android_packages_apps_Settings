...
public class DeviceInfoSettings extends RestrictedSettingsFragment {
    ...
    private static final String KEY_WEB_PAGE = "page_animerom";
    private static final String KEY_DEVICE_CPU = "device_cpu";
    private static final String KEY_DEVICE_MEMORY = "device_memory";
    private static final String KEY_ABOUT_ANIM = "about";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_MOD_VERSION, "ro.prome.version");
	...
	//CPU info and Memory info TeamMEX
	String cpuInfo = getCPUInfo();
        ...
        Utils.updatePreferenceToSpecificActivityOrRemove(act, parentPreference, KEY_TEAM,
                Utils.UPDATE_PREFERENCE_FLAG_SET_TITLE_TO_MATCHING_ACTIVITY);
        Utils.updatePreferenceToSpecificActivityOrRemove(act, parentPreference, KEY_ABOUT_ANIM,
                Utils.UPDATE_PREFERENCE_FLAG_SET_TITLE_TO_MATCHING_ACTIVITY);
	...
	//MEM INFO AND CPU INFO By TEAMMEX
